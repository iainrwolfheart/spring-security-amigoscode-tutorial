...
//        this.secretKey = secretKey;
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest,
        ...
        try {
            ...
            var authoritiesAsStringList = (List<Map<String, String>>) body.get("authorities");

            Set<SimpleGrantedAuthority> simpleGrantedAuthorities = authoritiesAsStringList.stream()
...
//        Passes the req/res on to the next filter in the chain
        filterChain.doFilter(httpServletRequest, httpServletResponse);
    }
}
